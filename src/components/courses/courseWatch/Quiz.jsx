...
function Quiz({ questions = [], onComplete }) {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl p-6" role="region" aria-label="Quiz">
      {/* Progress Bar */}
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {/* Question */}
          <div id={`question-${currentQuestion}`} tabIndex="-1" className="space-y-4">
          ...
          <ul className="space-y-3" role="radiogroup" aria-label="Answer options">
            {['a', 'b', 'c', 'd'].map((option) => {
              ...
              return (
                <li key={option}>
                  <button
                    onClick={() => handleAnswerSelect(currentQuestion, answerKey)}
