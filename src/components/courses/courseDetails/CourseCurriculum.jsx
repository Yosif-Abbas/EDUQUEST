          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-x-2">
                <IoPlayCircleOutline color="#564FFD" />
                <span className="text-nowrap">{section.lectures.length} lectures</span>
                <CiClock2 color="#FD8E1F" />
                <span className="text-nowrap">{calculateSectionDuration(section)}</span>
              </div>
            </div>
                ...
                {section.lectures?.map((lecture) => (
                  ...
                  >
                    ...
                    <div className="flex w-full justify-between">
                      ...
                      <span className="text-gray-500">{lecture.content_info}</span>
                    </div>
                  </li>
                ))}
              </ul>
